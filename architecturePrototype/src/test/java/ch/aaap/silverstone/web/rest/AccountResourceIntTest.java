...
import ch.aaap.silverstone.domain.Authority;
import ch.aaap.silverstone.domain.User;
import ch.aaap.silverstone.repository.AuthorityRepository;
...
import ch.aaap.silverstone.web.rest.errors.ExceptionTranslator;
import ch.aaap.silverstone.web.rest.vm.KeyAndPasswordVM;
...
@SpringBootTest(classes = SilverstoneApp.class)
